...
def help(update, context):
    update.message.reply_text('ᴅᴛö🇦🇿 𝘚𝘰𝘻𝘶 𝘛𝘢𝘱 📕 Söz Oyun botunun əmirləri.:\n\n' +
...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="➕ Məni Qrupa əlavə ed ➕", url="https://t.me/DTOCrobot?startgroup=a")
        sohbet = InlineKeyboardButton(text="Sahib 👨‍💻 ", url="https://t.me/Thagiyevv")
        oyun = InlineKeyboardButton(text="USTA Bots 🛠️", url="https://t.me/RiyaddBlogg")
        oksi = InlineKeyboardButton(text="Qurup 🛠", url="https://t.me/DTOTeammm")
      #  oksi = InlineKeyboardButton(text="USTA Bots 🛠️", url="https://t.me/thagiyevv") 

        keyboard = [[addme],[sohbet],[oyun],[oksi]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        update.message.reply_text('Salam. Mənim Adım ᴅᴛö🇦🇿 𝘚𝘰𝘻𝘶 𝘛𝘢𝘱 📕 Söz Oyun bot.\nQruplarda Əyləncəli vaxd keçirmək üçün yaradıldım.\n\nℹ️ Qrup Əlavə edərək /game əmrinə toxunun bu sizi aparıcı edəcəkdir.\nSizə gösdəriləm sözü doslarınız izah edməyə başlayın.\nSözü tapan şəxs qalib eylan olunacaq.\n\n📎Ətraflı məlumat almaq üçün /help əmrinə toxunun.', reply_to_message_id=True, reply_markup=reply_markup)
    else:
